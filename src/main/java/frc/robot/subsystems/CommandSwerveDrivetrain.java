...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  private PIDController yAxisController = new PIDController(2.0, 0.0, 0.0);
  ...
  public SignalMeasurement<Angle> getPigeonRotation() {
  ...
  public double getTrenchOffset() {
    ...
    boolean farX = Math.abs(pose.getX() - Inches.of(469.11).in(Meters))
